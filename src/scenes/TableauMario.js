class TableauMario extends Tableau{
    ...
    preload() {
        ...
        // ------pour TILED-------------
        // nos images
        this.load.image('star', 'assets/Champignon.png');
        this.load.image('tiles', 'assets/Tiledmap/TileSheet.png');
        //les données du tableau qu'on a créé dans TILED
        this.load.tilemapTiledJSON('map', 'assets/Tiledmap/SMarioBrosV2.json');
    ...
    create() {
        ...
        this.starsObjects = this.map.getObjectLayer('Champi')['objects'];
